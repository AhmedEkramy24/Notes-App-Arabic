...
export default function EditModal({ setOpenEditModal, getNotes, id }) {
  ...
  return (
    <>
      <div className="z-50 fixed top-0 start-0 end-0 bottom-0 dark:text-white bg-black bg-opacity-30 flex justify-center items-center p-2">
        <form
          className="md:w-1/2 w-full mx-auto bg-white p-6 rounded-lg dark:bg-slate-800"
          onSubmit={formik.handleSubmit}
        >
          <h1 className="text-center">تعديل المهمة</h1>
          <div className="mb-5">
            <label
              htmlFor="title"
